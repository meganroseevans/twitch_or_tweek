SELECT
  ...
  CASE
    ...
    WHEN LOWER(name) LIKE "%chat%" OR LOWER(name) LIKE "%mistletoebird%" OR LOWER(name) LIKE "%bellbird%" OR LOWER(name) LIKE "%monarch%" OR LOWER(name) LIKE "%pardalote%" OR LOWER(name) LIKE "%sunbird%" LOWER(name) LIKE "%spinebill%" OR LOWER(name) LIKE "%whiteface%" OR LOWER(name) LIKE "%crossbill%" OR LOWER(name) LIKE "%waxwing%" OR LOWER(name) LIKE "%yellowhammer%"OR LOWER(name) LIKE "%siskin%" OR LOWER(name) LIKE "%firecrest%" OR LOWER(name) LIKE '%goldcrest%' OR LOWER(name) LIKE '%leiothrix%' THEN "little_colourful_birds"
    WHEN LOWER(name) LIKE "%fairywren%" THEN "fairywren"
    WHEN LOWER(name) LIKE "%penguin%" THEN "penguin"
    WHEN LOWER(name) LIKE "%puffin%" OR LOWER(name) LIKE "%loon%" OR LOWER(name) LIKE "%razorbill%" OR LOWER(name) LIKE "%guillemot%" OR LOWER(name) LIKE "%dovekie%" OR LOWER(name) LIKE "%murre%" THEN "puffin_and_co"
