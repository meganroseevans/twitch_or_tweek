...
if "bird_images" not in st.session_state:
    st.session_state.bird_images = pd.read_csv('twitch_or_tweek/ebird_images.csv') #streamlit runs from the main directory rather than the subdirectory the python file is in
...
st.sidebar.metric("",st.session_state.score)
